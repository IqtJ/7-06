...
--shoot
local shootButton = display.newImageRect ( "assets/shoot.png", 50, 50 )
shootButton.x = 440
shootButton.y = display.contentCenterY 
...
function shootButton:touch( event )
    if ( event.phase == "began" ) then
        ...
        local aSingleBullet = display.newImageRect ( "assets/kunai.png", 30, 5 )
